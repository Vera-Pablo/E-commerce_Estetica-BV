...
<head>
    ...
    <title>Registro - Estética BV</title>
            ...
            <div class="col-12 col-lg-10 col-xl-8">
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-lg-6 mb-5 mb-lg-0 d-none d-lg-block">
                        <img src="<?= base_url('assets/images/banners/bv.png') ?>" class="w-100 rounded-4 shadow-4" alt="Estética BV" style="box-shadow: 0px 10px 7px rgba(0, 0, 0, 0.26); object-fit: cover; height: 580px;" />
                    </div>
                </div>
            </div>
        </div>
